...
#define EN0	1	/* MODE == encrypt */
#define DE1	0	/* MODE == decrypt */

void s_DesInit(void);
void des(unsigned char *input,unsigned char *output,unsigned char *key,int mode);

static void scrunch(unsigned char *, unsigned long *);
static void unscrun(unsigned long *, unsigned char *);
static void desfunc(unsigned long *, unsigned long *);
static void cookey(unsigned long *,  unsigned long *);
static void deskey(unsigned char *, int, unsigned long *);
static void s_des(unsigned char *, unsigned char *,  unsigned long *);
...
void deskey(unsigned char *key, int edf, unsigned long *KnL)	/* Thanks to James Gillogly & Phil Karn! */
{
...
static void cookey(register unsigned long *raw1, unsigned long *KnL)
{
...
void s_des(unsigned char *inblock, unsigned char *outblock, unsigned long *KnL)
{

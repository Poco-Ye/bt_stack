...
#define IAP_COMMAND_PAYLOAD_SIZE(_x)                              (STRUCTURE_OFFSET(IAP_Command_Payload_t, CommandData) + (_x))
   ...
   /*          This structure definition is provided to merely show     */
   /*          the format of a small packet.  Because of this, the      */
   /*          Checksum member will not be directly accessable in the   */
   /*          structure definition as it will follow the command       */
   /*          payload (which contains variable length data).           */
...
#define IAP_SMALL_PACKET_SIZE(_x)                                 (IAP_SMALL_PACKET_HEADER_SIZE + IAP_COMMAND_PAYLOAD_SIZE(_x) + CHECKSUM_DATA_SIZE)
   ...
   /*          packet in that the command payload is variable length.   */
   /*          This structure definition is provided to merely show     */
   /*          the format of a large packet.  Because of this, the      */
   /*          Checksum member will not be directly accessable in the   */
   /*          structure definition as it will follow the command       */
   /*          payload (which contains variable length data).           */
...
#define IAP_FID_TOKEN_SIZE(_x)                                    (STRUCTURE_OFFSET(IAP_FID_Token_t, FID_Data) + (_x))
   ...
   /* Definition for the Sesssion Types specified in the Session Info   */
   /* structure.                                                        */

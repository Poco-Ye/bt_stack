...
#define HCITR_ERROR_INVALID_PARAMETER        (-1)       /* Denotes that an    */
                                                        /* error occured      */
                                                        /* caused by an       */
                                                        /* invalid parameter  */
                                                        /* being passed to a  */
...
#define HCITR_ERROR_UNABLE_TO_OPEN_TRANSPORT (-2)       /* Denotes that the   */
                                                        /* there was an error */
                                                        /* opening the        */
                                                        /* transport layer.   */

#define HCITR_ERROR_READING_FROM_PORT        (-3)       /* Denotes that an    */
                                                        /* error occured      */
                                                        /* reading from the   */
                                                        /* transport layer    */
                                                        /* port.              */

#define HCITR_ERROR_WRITING_TO_PORT          (-4)       /* Denotes that an    */
                                                        /* error occured      */
                                                        /* writing to the     */
                                                        /* transport layer    */
                                                        /* port.              */

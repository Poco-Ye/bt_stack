...
BTPSAPI_DECLARATION int BTPSAPI L2CA_Disconnect_Request(unsigned int BluetoothStackID, Word_t LCID);
   ...
   /* The following function is responsible for Responding to a L2CAP   */
   /* Disconnect Indication Event. This function allows the recipient of*/
   /* the L2CAP Event the option of Responding to the Disconnection     */
   ...
   /* to this function are the Bluetooth Protocol Stack ID, the L2CAP   */
   /* Identifier (this value was passed to the caller in the caller in  */
   /* the L2CAP Disconnect Indication Event), and the L2CAP Connection  */
   /* Accept Result (Accept, Pending, or Rejection Reason), and finally */
   /* the Status of the Connection (Authorization Pending, etc.).  This */
   /* function returns zero if the L2CAP Disconnection Response was     */

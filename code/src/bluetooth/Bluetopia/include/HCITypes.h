...
#define HCI_LE_SUPPORTED_HOST_LE_SUPPORTED_HOST_ENABLED                 0x01
   ...
   /* The following constants represent the Bluetooth Low Energy (LE)   */
   /* Host Simulatneous supported values that are used to inform the    */
...
#define HCI_SUPPORTED_COMMAND_USER_CONFIRMATION_REQUEST_NEGATIVE_REPLY_BIT_NUMBER 0x99
...
#define HCI_SUPPORTED_COMMAND_IO_CAPABILITIES_RESPONSE_NEGATIVE_REPLY_BIT_NUMBER  0xA3
#define HCI_SUPPORTED_COMMAND_READ_ENCRYPTION_KEY_SIZE_BIT_NUMBER                 0xA4
...
#define HCI_SUPPORTED_COMMAND_READ_ENHANCED_TRANSMIT_POWER_LEVEL_BIT_NUMBER       0xC8
#define HCI_SUPPORTED_COMMAND_READ_BEST_EFFORT_FLUSH_TIMEOUT_BIT_NUMBER           0xCA
#define HCI_SUPPORTED_COMMAND_WRITE_BEST_EFFORT_FLUSH_TIMEOUT_BIT_NUMBER          0xCB
#define HCI_SUPPORTED_COMMAND_SHORT_RANGE_MODE_BIT_NUMBER                         0xCC
#define HCI_SUPPORTED_COMMAND_READ_LE_HOST_SUPPORT_BIT_NUMBER                     0xCD
#define HCI_SUPPORTED_COMMAND_WRITE_LE_HOST_SUPPORT_BIT_NUMBER                    0xCE
#define HCI_SUPPORTED_COMMAND_LE_SET_EVENT_MASK_BIT_NUMBER                        0xD0
#define HCI_SUPPORTED_COMMAND_LE_READ_BUFFER_SIZE_BIT_NUMBER                      0xD1
#define HCI_SUPPORTED_COMMAND_LE_READ_LOCAL_SUPPORTED_FEATURES_BIT_NUMBER         0xD2
#define HCI_SUPPORTED_COMMAND_LE_SET_RANDOM_ADDRESS_BIT_NUMBER                    0xD4
#define HCI_SUPPORTED_COMMAND_LE_SET_ADVERTISING_PARAMETERS_BIT_NUMBER            0xD5
#define HCI_SUPPORTED_COMMAND_LE_READ_ADVERTISING_CHANNEL_TX_POWER_BIT_NUMBER     0xD6
#define HCI_SUPPORTED_COMMAND_LE_SET_ADVERTISING_DATA_BIT_NUMBER                  0xD7
#define HCI_SUPPORTED_COMMAND_LE_SET_SCAN_RESPONSE_DATA_BIT_NUMBER                0xD8
#define HCI_SUPPORTED_COMMAND_LE_SET_ADVERTISE_ENABLE_BIT_NUMBER                  0xD9
#define HCI_SUPPORTED_COMMAND_LE_SET_SCAN_PARAMETERS_BIT_NUMBER                   0xDA
#define HCI_SUPPORTED_COMMAND_LE_SET_SCAN_ENABLE_BIT_NUMBER                       0xDB
#define HCI_SUPPORTED_COMMAND_LE_CREATE_CONNECTION_BIT_NUMBER                     0xDC
#define HCI_SUPPORTED_COMMAND_LE_CREATE_CONNECTION_CANCEL_BIT_NUMBER              0xDD
#define HCI_SUPPORTED_COMMAND_LE_READ_WHITE_LIST_SIZE_BIT_NUMBER                  0xDE
#define HCI_SUPPORTED_COMMAND_LE_CLEAR_WHITE_LIST_BIT_NUMBER                      0xDF
#define HCI_SUPPORTED_COMMAND_LE_ADD_DEVICE_TO_WHITE_LIST_BIT_NUMBER              0xE0
#define HCI_SUPPORTED_COMMAND_LE_REMOVE_DEVICE_FROM_WHITE_LIST_BIT_NUMBER         0xE1
#define HCI_SUPPORTED_COMMAND_LE_CONNECTION_UPDATE_BIT_NUMBER                     0xE2
#define HCI_SUPPORTED_COMMAND_LE_SET_HOST_CHANNEL_CLASSIFICATION_BIT_NUMBER       0xE3
#define HCI_SUPPORTED_COMMAND_LE_READ_CHANNEL_MAP_BIT_NUMBER                      0xE4
#define HCI_SUPPORTED_COMMAND_LE_READ_REMOTE_USED_FEATURES_BIT_NUMBER             0xE5
#define HCI_SUPPORTED_COMMAND_LE_ENCRYPT_BIT_NUMBER                               0xE6
#define HCI_SUPPORTED_COMMAND_LE_RAND_BIT_NUMBER                                  0xE7
#define HCI_SUPPORTED_COMMAND_LE_START_ENCRYPTION_BIT_NUMBER                      0xE8
#define HCI_SUPPORTED_COMMAND_LE_LONG_TERM_KEY_REQUEST_REPLY_BIT_NUMBER           0xE9
#define HCI_SUPPORTED_COMMAND_LE_LONG_TERM_KEY_REQUEST_NEGATIVE_REPLY_BIT_NUMBER  0xEA
#define HCI_SUPPORTED_COMMAND_LE_READ_SUPPORTED_STATES_BIT_NUMBER                 0xEB
#define HCI_SUPPORTED_COMMAND_LE_RECEIVER_TEST_BIT_NUMBER                         0xEC
#define HCI_SUPPORTED_COMMAND_LE_TRANSMITTER_TEST_BIT_NUMBER                      0xED
#define HCI_SUPPORTED_COMMAND_LE_TEST_END_BIT_NUMBER                              0xEE
...
#define HCI_LMP_COMPID_MANUFACTURER_NAME_QUALCOMM_LABS_INC              0x008C
...
#define HCI_LE_ADVERTISING_REPORT_DATA_TYPE_TYPE_SIMPLE_PAIRING_HASH_C                 0x0E
#define HCI_LE_ADVERTISING_REPORT_DATA_TYPE_TYPE_SIMPLE_PAIRING_RANDOMIZER_R           0x0F

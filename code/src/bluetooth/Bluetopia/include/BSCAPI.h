...
BTPSAPI_DECLARATION int BTPSAPI BSC_StartTimer(unsigned int BluetoothStackID, unsigned int Timeout, BSC_Timer_Callback_t BSC_TimerCallback, unsigned long CallbackParameter);

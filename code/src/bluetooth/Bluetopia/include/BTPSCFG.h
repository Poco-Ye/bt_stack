...
#define BTPS_CONFIGURATION_RFCOMM_MAXIMUM_SUPPORTED_STACK_FRAME_SIZE      (L2CAP_MAXIMUM_SUPPORTED_STACK_MTU - 6)
#define BTPS_CONFIGURATION_RFCOMM_DEFAULT_MAXIMUM_NUMBER_QUEUED_DATA_PACKETS  3
#define BTPS_CONFIGURATION_RFCOMM_DEFAULT_QUEUED_DATA_PACKETS_THRESHOLD       1
...
#define BTPS_CONFIGURATION_AUD_REMOTE_CONTROL_MAXIMUM_FRAGMENTS                8

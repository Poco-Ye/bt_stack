...
#define AS3911_REG_FIFO_READ                     0xBF        /* FIFO_READ  add by WanLiShan */
#define AS3911_REG_FIFO_WRITE                    0x80        /* FIFO_WRITE add by WanLiShan */
...
#define AS3911_CMD_SET_DEFAULT                   0xC1    /*!< Put the chip into the default state (same as after power-up). */
#define AS3911_CMD_CLEAR_FIFO                    0xC2    /*!< Clear the FIFO and stop all activities (e.g. timers). */
...
#define AS3911_CMD_INITIAL_RF_COLLISION          0xC8    /*!< Perform NFC initial RF collision avoidance. */
#define AS3911_CMD_RESPONSE_RF_COLLISION_N       0xC9    /*!< Perform NFC response RF collision avoidance. */
#define AS3911_CMD_RESPONSE_RF_COLLISION_0       0xCA    /*!< Perform NFC response RF Collision avoidance with n=0. */
#define AS3911_CMD_NORMAL_NFC_MODE               0xCB    /*!< Switch from NFC target bit rate detection mode to normal NFC mode. */
#define AS3911_CMD_ANALOG_PRESET                 0xCC    /*!< Analog Preset */
#define AS3911_CMD_MASK_RECEIVE_DATA             0xD0    /*!< Disable receiver, RSSI, and AGC. */
#define AS3911_CMD_UNMASK_RECEIVE_DATA           0xD1    /*!< Enable receiver, RSSI, and AGC. */
#define AS3911_CMD_MEASURE_AMPLITUDE             0xD3    /*!< Measure singal amplitude on RFI inputs. */
#define AS3911_CMD_SQUELCH                       0xD4    /*!< Start squelch process. */
#define AS3911_CMD_CLEAR_SQUELCH                 0xD5    /*!< Clear squelch gain reduction and stop any ongoing squelch process. */
#define AS3911_CMD_ADJUST_REGULATORS             0xD6    /*!< Adjust the voltage regulators. */
#define AS3911_CMD_CALIBRATE_MODULATION          0xD7    /*!< Calibrate modulation depth. */
#define AS3911_CMD_CALIBRATE_ANTENNA             0xD8    /*!< Calibrate antenna trimming. */
#define AS3911_CMD_MEASURE_PHASE                 0xD9    /*!< Measure the phase difference between the RFO and RFI signals. */
#define AS3911_CMD_MEASURE_RSSI                  0xDA    /*!< clear the RSSI bits and restart RSSI measurement. */
#define AS3911_CMD_TRANSPARENT_MODE              0xDC    /*!< Set the chip into transparent mode. */
#define AS3911_CMD_CALIBRATE_C_SENSOR            0xDD    /*!< Calibrate the capacitive sensor. */
#define AS3911_CMD_MEASURE_CAPACITANCE           0xDE    /*!< Measure the capacitance between CSI and CSO pins. */
#define AS3911_CMD_MEASURE_VSS                   0xDF    /*!< Measure the power supply voltage. */
#define AS3911_CMD_START_GP_TIMER                0xE0    /*!< Start the general purpose timer. */

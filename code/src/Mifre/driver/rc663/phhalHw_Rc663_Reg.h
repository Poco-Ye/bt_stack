...
* \em Note: Also contains 1 additional Water-Level bits (MSB) and 2 additional FIFO-Length bits (also MSB).
*/
...
#define PHHAL_HW_RC663_REG_IRQINV               0x80
...
*/
#define PHHAL_HW_RC663_REG_DRVMOD               0x28
...
* TODO.
*/
#define PHHAL_HW_RC663_REG_PADEN                0x44

/** \brief TODO.
*
* TODO.
*/
#define PHHAL_HW_RC663_REG_PADOUT               0x45

/** \brief TODO.
*
* TODO.
*/
#define PHHAL_HW_RC663_REG_PADIN                0x46

/** \brief TODO.
*
* TODO.
*/
#define PHHAL_HW_RC663_REG_SIGOUT               0x47

/** \brief Tx Bit-Mode Register.
*
* Configure bitorder, parity settings and start/stop bit settings of transmitter.
*/
#define PHHAL_HW_RC663_REG_TXBITMOD             0x48
...
/** \brief Rx Bit-Mode Register.
*
* Configure bitorder, parity settings and stop bit settings of receiver.
*/
...
#define PHHAL_HW_RC663_CMD_TRANSMIT             0x06U    /**< Transmits data from the FIFO buffer. */
#define PHHAL_HW_RC663_CMD_TRANSCEIVE           0x07U    /**< Transmits data from FIFO buffer and automatically activates the receiver after transmission is finished. */
...
*/
/*@{*/
#define PHHAL_HW_RC663_MASK_CW_AMPLITUDE        0xF0U
#define PHHAL_HW_RC663_MASK_RESIDUAL_CARRIER    0x0FU
/*@}*/
...
#define PHHAL_HW_RC663_MASK_CRCPRESETVAL        0x07U

...
#define ICC_ERR_PARS               ( -2807 )/* only be used in communication kernel */
#define ICC_ERR_BWT                ( -2808 )/* only be used in communication kernel */
#define ICC_ERR_CWT                ( -2809 )/* only be used in communication kernel */

 ...
 * $Id: lbuf.h,v 1.4 2009-11-27 18:11:59 Exp $
 */
...
#define LBUFCFGSZ	32*1024	/* largest reasonable packet buffer, driver uses for ethernet MTU */

#define	NTXBUF		32	/* # local transmit buffers */
#define	NRXBUF		16	/* # local receive buffers */
#define	NCFGBUF		1	/* # local cfg buffers */
...
typedef struct lbuf_info {
	...
	struct lbfree	cfgfree;	/* cfg packet freelist */
} lbuf_info_t;

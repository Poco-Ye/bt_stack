...
#define ALT_ADDRESS_PIN_HIGH    1
#define ALT_ADDRESS_PIN_LOW     0

#define ALT_ADDRESS_PINSTATUS   ALT_ADDRESS_PIN_LOW

#if (ALT_ADDRESS_PINSTATUS == 1)
    #define TILTSENSOR_WRITE_ADDR   0x3A
    #define TILTSENSOR_READ_ADDR    0x3B  
#else
    #define TILTSENSOR_WRITE_ADDR   0xA6
    #define TILTSENSOR_READ_ADDR    0xA7
#endif
...
/*uchar SetTransPermitMaxAngle(uchar ucAngleValue);
uchar CheckIfPermitTrans(void);*/
